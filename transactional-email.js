...
function emailConfig(env = process.env) {
  return {
    ...
    notify: clean(env.WILD_SAGE_NOTIFICATION_EMAIL || env.WILD_SAGE_NOTIFY_EMAIL || env.WILD_SAGE_OWNER_EMAIL || env.OWNER_NOTIFICATION_EMAIL || env.ORDER_NOTIFICATION_EMAIL)
  };
}
